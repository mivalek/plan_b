        ...
        <section id="climb">
          <div className="section-content">
            <div className="blurb">
              <h2>Climb</h2>
              <p>
                Choose from around 100 fun boulders of all levels of difficulty
                in our two rooms with a combined wall area of ...m<sup>2</sup>.
        ...
        <section id="celebrate">
          ...
          <div className="section-content">
            <div className="blurb">
              <h2>Celebrate</h2>
              <p>
                Plan B is a great place for kids to celebrate their birthdays
